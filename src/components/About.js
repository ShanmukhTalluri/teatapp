...
const About=()=>{
  let [style_,setStyle_]=useState({
    color:"black",
    backgroundColor:"white",
  });
  const [btnChange,setBtnChange] = useState("Enable Dark Mode");
  let DarkLightMode=()=>{
    if(style_.color==="black" && style_.backgroundColor==="white"){
      setStyle_({
        color:"blue",
    ...
    return(
        <><div className="container" style={style_}>
            <h1 className="my-3">About Us</h1>
        <div class="accordion" id="accordionExample">
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingOne">
            <button class="accordion-button" style={style_} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
              Accordion Item #1
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingTwo">
            <button class="accordion-button collapsed" style={style_} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
              Accordion Item #2
            </button>
          </h2>
        ...
        <div class="accordion-item">
          <h2 class="accordion-header" id="headingThree">
            <button class="accordion-button collapsed" style={style_} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
              Accordion Item #3
            </button>
          </h2>
      ...
      <div>
      <button type="button" class="btn btn-info my-3" onClick={DarkLightMode}>enable dark mode</button>
      </div>
      </div>
      </>
    );
